...
def main():
    ...
    # Load a model
    model = YOLO(r"D:\aanya\yolov8n.pt")  # Using raw string to handle backslashes correctly

    # Customize training settings
    model.train(data=r"D:\aanya\data.yaml", epochs=50, batch=16, imgsz=640, device="0")
