...
def main():
    ...
    # Load a model
    model = YOLO(r"E:\fod_and_crack\yolov8s.pt")  # Using raw string to handle backslashes correctly

    # Customize training settings
    model.train(data=r"data.yaml", epochs=20, batch=16, imgsz=640, device="0")
